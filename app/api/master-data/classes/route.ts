...
export async function GET(){try{return NextResponse.json(await prisma.classRoom.findMany({orderBy:[{isActive:'desc'},{name:'asc'}],include:{_count:{select:{students:true}}}}));}catch(e){return errorResponse(e)}}
