...
import { requirePermission, requireAnyPermission, errorResponse } from '@/lib/api';
import { normalizePhone } from '@/lib/phone';

export async function GET(req: Request) {
  const denied = await requireAnyPermission(['students.view','billing.view','savings.view','reports.view']); if (denied) return denied;
