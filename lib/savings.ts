...
export type SavingsDirection = 'positive' | 'negative';
export function getSavingsDirection(type: string): SavingsDirection {
  return type === 'DEPOSIT' || type === 'WITHDRAWAL_CORRECTION' ? 'positive' : 'negative';
}
